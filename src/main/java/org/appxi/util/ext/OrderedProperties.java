...
public final class OrderedProperties implements Serializable {
     ...
     */
    public OrderedProperties load(InputStream stream) throws IOException {
     ...
     */
    public OrderedProperties load(Reader reader) throws IOException {
        CustomProperties customProperties = new CustomProperties(this.properties);
        customProperties.load(reader);
        return this;
    }

    public OrderedProperties load(Properties properties) {
        if (null == properties)
            return this;
        properties.forEach((k, v) -> this.setProperty(String.valueOf(k), String.valueOf(v)));
        return this;
    }

    public OrderedProperties load(OrderedProperties properties) {
        if (null == properties)
            return this;
     ...
     */
    public OrderedProperties loadFromXML(InputStream stream) throws IOException {
        CustomProperties customProperties = new CustomProperties(this.properties);
    ...
    public static OrderedProperties copyOf(OrderedProperties source) {
        ...
        // copy the properties from the source to the utils
    ...
    private static final class CustomProperties extends Properties {
        private static final long serialVersionUID = 8681103188572893949L;
